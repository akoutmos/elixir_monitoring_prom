defmodule ElixirMonitoringPromWeb.Endpoint do
  use Phoenix.Endpoint, otp_app: :elixir_monitoring_prom

  socket "/socket", ElixirMonitoringPromWeb.UserSocket,
    websocket: true,
    longpoll: false
